(function($) {
    ...
    // Team owlCarousel
    $('.Aarav-team .owl-carousel').owlCarousel({
        loop: true,
        margin: 30,
        dots: false,
        mouseDrag: true,
    ...
    $(".Aarav-testimonials .owl-carousel, .blocks .owl-carousel, .Aarav-testimonial-item .owl-carousel").owlCarousel({
        items: 1,
        loop: true,
        dots: false,
        mouseDrag: false,
    ...
    // Blog owlCarousel
    $('.Aarav-blog .owl-carousel').owlCarousel({
        loop: true,
        margin: 30,
        mouseDrag: true,
        autoplay: false,
    ...
    // Button
    var buttons = document.querySelectorAll(".Aarav-btn .Aarav-btn2");
